...
abstract class Pendaftaran {
    // Properti Terenkapsulasi sesuai ketentuan soal
    ...
    // Abstract Method yang wajib diturunkan dan diisi oleh kelas anak
    abstract public function hitungTotalBiaya();
    abstract public function tampilkanInfoSpesifik();

    // Getter agar nilai protected bisa dibaca saat menampilkan data di file utama
